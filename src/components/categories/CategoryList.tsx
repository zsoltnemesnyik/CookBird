...
const CategoryList = ({ setSelectedCategory }: { setSelectedCategory: (categoryId: string) => void }) => {
    ...
    return (
        <div className="flex flex-col items-start">
            {categories.map((category) => (
                <CategoryLink key={category.idCategory} category={category} setSelectedCategory={setSelectedCategory} />
            ))}
        </div>
    )
};
